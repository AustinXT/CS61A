...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    ones1 = player_score % 10
    ones2 = opponent_score % 10
    return abs(ones1-ones2) == (opponent_score//10) % 10
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who:
            ...
            if abs(num_rolls1-last_turn_score1) == 2 and feral_hogs:
                score1 += 3
            ...
            if abs(num_rolls0-last_turn_score0) == 2 and feral_hogs:
                score0 += 3
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        if who == 0:
            ...
            if score0-last_score > running_high0:
                running_high0 = score0-last_score
                print(
                    f"{running_high0} point(s)! That's the biggest gain yet for Player {who}")
        else:
            running_high1 = running_high
            if score1-last_score > running_high1:
                running_high1 = score1-last_score
                print(
                    f"{running_high1} point(s)! That's the biggest gain yet for Player {who}")

        return announce_highest(who, score1 if who else score0, running_high1 if who else running_high0)
    return say
    # END PROBLEM 7
...
def final_strategy(score, opponent_score, cutoff=5, num_rolls=6):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    fb = free_bacon(opponent_score)
    if is_swap(score + fb, opponent_score):
        if opponent_score < cutoff + score + fb:
            return num_rolls
        else:
            return 0
    else:
